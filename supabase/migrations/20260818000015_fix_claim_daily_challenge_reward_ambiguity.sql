-- ============================================================================
-- ONE MORE RUSH — Migration 00015: Fix Column Ambiguity in claim_daily_challenge_reward
-- Resolves "column reference 'tier' is ambiguous" error by explicitly qualifying
-- all catalog and ledger table column references in public.claim_daily_challenge_reward().
-- Preserves all economic semantics, advisory locks, and server catalog validations.
-- ============================================================================
...
begin
  ...
  -- Explicitly qualify cat.game_id, cat.tier, cat.points to prevent column ambiguity with output parameter 'tier'
